...
class Hush < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "cb512a6318bfe85997e4f5e4e3d5645a6863001844cd500e33e038087ab37cf0"
    else
      url "https://github.com/Matuyuhi/hush/releases/download/v#{version}/hush-x86_64-apple-darwin.tar.gz"
      sha256 "ed2e795016b1a4a959f198bc6a4a588d069adcce6d7e2d314f521ec7f3dcbcba"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "53b93f35ceb8f53589e8277882b8dfd33497a6d658396c06a438f2bd5aeb4e78"
    else
      url "https://github.com/Matuyuhi/hush/releases/download/v#{version}/hush-x86_64-linux.tar.gz"
      sha256 "6d0f1930e015e5f791372b332137962bfe7777b92c47f820f3c031f60caf3205"
    end
  end
