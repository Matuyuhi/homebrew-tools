...
class Hush < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "230b87fc49e66bc7be7a4b8f2672edbaa7671babcdba9868c40e6acc3a66c19e"
    else
      url "https://github.com/Matuyuhi/hush/releases/download/v#{version}/hush-x86_64-apple-darwin.tar.gz"
      sha256 "9a872a14ea2c0ce669a5bd14c3b0d4006724ade74048292578b8235a484b2b6f"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "ae1bdb56c26e371998088170fc33dda9d304cd48cb82e57a6853e90ba2c1cfd5"
    else
      url "https://github.com/Matuyuhi/hush/releases/download/v#{version}/hush-x86_64-linux.tar.gz"
      sha256 "977a3e923923872baf75199e69ed5e3f01f52b64e3db0b613244f6696a09bf52"
    end
  end
